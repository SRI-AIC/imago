"""
Runs counterfactual experiments for the xAI 2023 for the Reaver Assault domain.
"""
import sys
import yaml
...
sc2_domain = load_domain(device=DEVICE)
sc2_domain.model.eval()

print(len(train_ds), len(test_ds))


sc2_domain.model.force_deterministic=True
